({
    ...
    initializeFromDesignAttribute: function(component) {
        var imageArrayStr = component.get('v.imageArrayStr') || '';
        imageArrayStr = imageArrayStr.replaceAll("'", "\"");
        var imageArray = JSON.parse(imageArrayStr);
        component.set('v.imageArray', imageArray);
        
        var height = component.get('v.height') || {};
        height.large = component.get('v.heightInLargeDevice');
        height.medium = component.get('v.heightInMediumDevice');
        height.small = component.get('v.heightInSmallDevice');
